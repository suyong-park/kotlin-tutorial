fun main() {
    ...
    // 먼저, a 시리즈 변수에 있는 값을 r 시리즈 변수에 담고 그 다음에 a 시리즈 변수의 값을 변동시킨다. 후위 연산자이기 때문이다.
    val r7:Int = a5++
    val r8:Int = a6--
    ...
    // 반대로 이는 a 시리즈 변수의 값을 변동한 후 그 값을 r 시리즈 변수에 담는다. 전위 연산자이기 때문이다.
    val r9:Int = ++a7
    val r10:Int = --a8
    ...
    val r16:IntRange = 10..20 // 10 ~ 20 사이의 값을 관리해 준다.
    println("r16 : $r16")
